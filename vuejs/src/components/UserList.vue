  ...
  <div>
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-popover trigger="hover" placement="right">
			  ...
			  <p>员工号: {{ scope.row.userCode }}</p>
              <p>住址: {{ scope.row.userAddress }}</p>
              <p>电话：{{ scope.row.userPhone}}</p>
			  <p>身份证号：{{ scope.row.userIdcard}}</p>
			  <p>岗位：{{ scope.row.userStation}}</p>
        ...
        <el-table-column
          ...
          label="岗位">
          <template slot-scope="scope">
            <span>{{ scope.row.userStation }}</span>
          </template>
        </el-table-column>		
        <el-table-column
          label="操作"
      ...
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="70px" class="demo-ruleForm" size="medium">
        <el-dialog
          ...
          <el-form-item label="岗位" prop="userStation">
            <el-input v-model="ruleForm.userStation"></el-input>
          </el-form-item> 		  
        ...
        methods: {
            ...
            addUser() {
                let postData = this.qs.stringify({
                    ...
                    userStation: this.ruleForm.userStation
